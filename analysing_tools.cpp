...
class AnalysisTools {
  ...
  public:
    ...
    static void intToDouble(int *values, size_t size, double **result);
};

void AnalysisTools::intToDouble(int *values, size_t size, double **result) {
...
int main(int argc, char *argv[]) {
  ...
  AnalysisTools::intToDouble(vals, 10, &dvals);
  for (int i = 0; i < 10; ++i) {
    std::cout << dvals[i] << std::endl;
  }
  if (dvals != 0) {
//    delete []dvals;
  }
